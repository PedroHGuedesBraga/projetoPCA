...
export default function NovoContratoModal({
  visible, onHide, secretariaNome, nome, onNomeChange, data, onDataChange,
  status, onStatusChange, importarItens, onImportarItensChange, ultimoContrato, onSalvar,
  ...
  return (
    <Dialog header="Novo Contrato" visible={visible} style={{ width: "40vw" }} modal onHide={onHide}>
      <div className="flex flex-column gap-3 p-3">
        ...
        <label>Data</label>
        <Calendar value={data} onChange={(e) => onDataChange(e.value as Date)} dateFormat="dd/mm/yy" placeholder="Selecione a data" className="w-full" />
